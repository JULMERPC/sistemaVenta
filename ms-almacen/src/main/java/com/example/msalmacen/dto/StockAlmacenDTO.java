...
public class StockAlmacenDTO {
    ...
    @NotNull(message = "ID de materia prima es obligatorio")
    private Long idMateriaPrima;

    @NotNull(message = "ID de almacén es obligatorio")
    private Long idAlmacen;
    ...
    // Información adicional para respuestas (solo lectura)
    private String nombreMateriaPrima;
    private String nombreAlmacen;
    private String unidadMedida;
    private BigDecimal stockMinimo;
    private Boolean stockBajo; // calculado

    // Constructor para crear DTO sin ID (para creación)
    public StockAlmacenDTO(Long idMateriaPrima, Long idAlmacen, BigDecimal stockActual) {
        this.idMateriaPrima = idMateriaPrima;
        this.idAlmacen = idAlmacen;
        this.stockActual = stockActual;
    }

    // Constructor con información completa para respuestas
    public StockAlmacenDTO(Long id, Long idMateriaPrima, Long idAlmacen,
                           BigDecimal stockActual, LocalDateTime ultimaActualizacion,
                           String nombreMateriaPrima, String nombreAlmacen,
        ...
        this.stockBajo = stockMinimo != null && stockActual != null &&
                stockActual.compareTo(stockMinimo) < 0;
    }

    // Método para verificar si el stock está bajo
    public Boolean isStockBajo() {
        if (stockMinimo != null && stockActual != null) {
